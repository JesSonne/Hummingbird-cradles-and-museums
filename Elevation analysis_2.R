...
#Vector listing terminal branch length of endemic species (33% range size quartile); missing species in the phylogeny were added based on a random sample from all R-values 
